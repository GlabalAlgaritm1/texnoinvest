...
import rasm30 from '../img/img-logo/rasm80.jpg'
...
import salom7 from '../img/img-logo/rasm81.png'
import salom8 from '../img/img-logo/rasm82.jpg'
import salom9 from '../img/img-logo/rasm83.png'
import salom10 from '../img/img-logo/rasm86.png'
import { Elements } from '../Elements'

import '../../Style/Style.css'

// swiper image
import swiperbir from '../img/img-logo/swiper60.jpg'
import swiperikki from '../img/img-logo/swiper61.jpg'
import swiperuch from '../img/img-logo/swiper62.jpg'
import swipertort from '../img/img-logo/swiper63.jpg'
import swiperbesh from '../img/img-logo/swiper64.jpg'
import swiperbolti from '../img/img-logo/swiper65.jpg'
import swiperyetti from '../img/img-logo/swiper66.jpg'
        ...
        <section>
            ...
            <div className={`${Elements.Container} flex flex-col md:flex-row items-center justify-between mx-auto gap-10 mb-28 px-4`}>
                ...
                <div className="w-full md:max-w-[400px]">
                    ...
                    <p>Modern trends in construction and architecture</p>
                </div>
            ...
            <div className={`${Elements.Container} my-16 px-4 relative mr-[300px]`}>
                ...
                >
                    {[swiperbir,swiperikki,swiperuch,swipertort,swiperbesh,swiperbolti,swiperyetti,swiperuch,swipertort,swiperbesh].map((img, i) => (
