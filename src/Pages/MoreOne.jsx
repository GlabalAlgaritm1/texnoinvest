...
const MoreOne = () => {
  ...
  return (
    <section className={`${Elements.Container}`}>
      ...
      <div>
        <div>
          <img className='w-full py-5' src={rasm30} alt="" />
        </div>
        ...
        <div>
          ...
          <div className='flex flex-col lg:flex-row items-center gap-10 sm:gap-12 lg:gap-14 px-3'>
            <div className='w-full max-w-[750px] md:px-6 px-3 mx-auto lg:ml-12'>
              ...
              <Link to='/New/MoreTwo' className='text-[#6e6b6b]'>
                {t('news.learnMore')}
              </Link>
            </div>
            <div>
        ...
        <div>
          <div className='flex items-center'>
            <span className='text-xl sm:text-3xl font-semibold mr-6 sm:mr-12'>03</span>
            <span className='border border-[#4b4949] w-full my-8 sm:my-12'></span>
          </div>
          <div className='flex flex-col lg:flex-row items-center gap-10 sm:gap-12 lg:gap-14 px-3'>
            <div className='w-full max-w-[750px] md:px-6 px-3 mx-auto lg:ml-12'>
